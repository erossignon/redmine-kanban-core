...
(function () {
    ...
    describe("Testing requirement matrix management", function () {
        ...
        function extract_covered_requirements(project,work_item) {
            ...
            queue.filter(is_user_stories).forEach(function(us){ _populate_requirements_map(m,us); });
        ...
        it("should extract the list of all covered requirements for a given user use case", function() {
